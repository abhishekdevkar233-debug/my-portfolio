...
export function GLSLHills({
  ...
  useEffect(() => {
    ...
    // WebGL isn't guaranteed (old GPUs, blocklists, headless). Fail soft so
    ...
    return () => {
      // The original never tore any of this down, leaving the RAF loop and the
      // GL context alive after unmount.
