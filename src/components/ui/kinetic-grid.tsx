...
export default function KineticGrid({
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const theme = isDark
        ...
        : {
            default: {
              bg: "#F2F4F7",
              lineActive: { r: 43, g: 111, b: 209, a: 0.9 },
              nodeActive: { r: 43, g: 111, b: 209, a: 1.0 },
              glow: "43,111,209",
              ripple: "43,111,209",
            },
            monochrome: {
              bg: "#FFFFFF",
              lineActive: { r: 20, g: 20, b: 20, a: 0.9 },
              nodeActive: { r: 20, g: 20, b: 20, a: 1.0 },
              glow: "20,20,20",
              ripple: "20,20,20",
            },
          }[globalColor ?? "default"];
    ...
    [getWarpedPoint, globalColor, isDark],
  );
  ...
  // ── Setup ───────────────────────────────────────────────────────────────────
  // Sized to the containing element (not the viewport) so this can be used as
  // a scoped background behind a section rather than only full-page.
  ...
  useEffect(() => {
    ...
    // cursor while it's over foreground content (portrait, text, etc.)
    // stacked above this background layer.
