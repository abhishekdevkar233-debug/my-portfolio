...
const EXPERTISE: DarkGridItem[] = [
  ...
  },
  {
    ...
    icon: Code2,
    desc: "I turn concepts and requirements into high-fidelity interfaces and interactive prototypes that communicate how a product should work and feel. I use prototyping to explore ideas, validate interactions, identify usability gaps, and establish a clear design direction before development.",
  },
];
